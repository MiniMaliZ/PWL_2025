                        ...
                        <tbody>
                            @foreach ($penjualan->detail as $i => $d)
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-sm btn-danger hapus-baris">Hapus Baris</button></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    <button type="button" class="btn btn-sm btn-success" id="tambah-baris">Tambah Barang</button>
                    <div class="form-group">
