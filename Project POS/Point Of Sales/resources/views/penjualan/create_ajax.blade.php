    ...
    <div id="modal-master" class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="button" class="btn btn-sm btn-success" id="tambah-barang">Tambah Barang</button>
...
<script>
    ...
    function tambahBaris() {
        ...
        barangs.forEach(barang => {
            barangOptions +=
                `<option value="${barang.barang_id}" data-harga="${barang.harga_jual}"  data-stok="${barang.stok}">${barang.barang_nama}</option>`;
        });
