            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $supplier->supplier_telepon }}" type="text" name="supplier_telepon" id="supplier_telepon"
                            class="form-control" required>
                    ...
                    <div class="form-group">
                        <label>Supplier Kota</label>
                        <input value="{{ $supplier->supplier_kota }}" type="text" name="supplier_kota" id="supplier_kota" class="form-control"
                            required>
                        <small id="error-supplier_kota" class="error-text form-text text-danger"></small>
                    </div>
                </div>
